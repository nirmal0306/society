...
@Component({
  selector: 'app-list-notice-resident',
  standalone: true,
  imports: [CommonModule, HttpClientModule, RouterModule, FormsModule, ResidentNavComponent],
  templateUrl: './list-notice-resident.component.html',
  styleUrl: './list-notice-resident.component.css'
})
export class ListNoticeResidentComponent implements OnInit {
